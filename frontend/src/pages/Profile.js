...
const Profile = () => {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "linear-gradient(135deg, #f8f9fa 0%, #ffe0ec 100%)" }}>
      <div className="responsive-card" style={{ background: "#fff", padding: 36, borderRadius: 18, boxShadow: "0 4px 24px rgba(0,0,0,0.08)", minWidth: 340, maxWidth: 420, width: "100%" }}>
        <h2 style={{ color: "#d72660", marginBottom: 24 }}>My Profile</h2>
